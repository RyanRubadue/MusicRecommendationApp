...
class MusicApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        BACKGROUND_IMAGE =tk.PhotoImage(r'C:\Users\M38853\Downloads\output-onlinepngtools.png')
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        leftFrame = tk.Frame(self, bg = '#5ACC72', highlightbackground="#4F8451", highlightthickness=2)
        ...
        leftFrame.grid(row = 0, column = 0, padx = 15, pady =15)
        #leftFrame.place(relx = .05, rely = .05, relwidth = .9, relheight = .9)
...
class ResultPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        mainLabel = tk.Label(self, text = "Aaaaaaand here you go!", bg = '#3BAD40', font = ('Segoe UI', 32, 'bold'), fg = 'white')
        returnButton = tk.Button(self, text = 'Return to welcome page', command = lambda: controller.show_frame("StartPage"))
        exportButton = tk.Button(self, text = 'Export Results')
