...
# https://developer.spotify.com/documentation/web-api/reference/browse/get-recommendations/ (Get recommendation seeds)
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        timelength = tk.StringVar() #Variable of the timelength to get user data for
        ...
        fullScreenButton = tk.Button(bgFrame, text = "Fullscreen", command = lambda: mainPageFunctions.toggleFullScreen(), bg = '#383F38', fg = "#75F993", font = ('Segoe UI', 8, 'bold'))
        #This button serves to provide a convenient way to exit the application
        exitButton = tk.Button(bgFrame, text = 'Exit', command = lambda: root.destroy(), bg = '#383F38', fg = "#75F993", font = ('Segoe UI', 8, 'bold'))
        ...
        leftFrame = tk.Frame(bgFrame, bg = '#5ACC72', highlightbackground="#383F38", highlightthickness=4)
        topFrame = tk.Frame(leftFrame, bg = '#5ACC72')
        bottomFrame = tk.Frame(leftFrame, bg = '#52F059', highlightbackground="#383F38", highlightthickness=2)
        ...
        numSongsLabel = tk.Label(bottomFrame, text = "= Number of Recommended Songs (1-10)", bg = "#52F059", font = ('Segoe UI', 16))
        numArtistsEntry = IntEntry(bottomFrame, bg = '#E9F0EA', fg = 'black', state = tk.DISABLED, width = 8)
        numArtistsLabel = tk.Label(bottomFrame, text = "= Number of Recommended Artists (1-10)", bg = "#52F059", font = ('Segoe UI', 16))

        userTimeLength = tk.Label(bottomFrame, text = "Select timelength of user information:", bg = "#52F059", font = ('Segoe UI', 18))
        ...
        userTimeLength.grid(row = 0, column = 0, padx = 30, pady = (40, 0), columnspan = 2, sticky = 'w')
        shortTermButton.grid(row = 1, column = 1, sticky = 'w')
        mediumTermButton.grid(row = 2, column = 1, sticky = 'w', columnspan = 2)
        longTermButton.grid(row = 3, column = 1, sticky = 'w', columnspan = 2)
        toDisplayCheckButton1.grid(row = 4, column = 0, sticky = 'w', padx = 30, columnspan = 2)
        toDisplayCheckButton2.grid(row = 6, column = 0, sticky = 'w', padx = 30, columnspan = 2)

        numSongsEntry.grid(row = 5, column = 0, padx = (100,0))
        numSongsLabel.grid(row = 5, column = 1, padx = 0, sticky = 'w')
        numArtistsEntry.grid(row = 7, column = 0, padx = (100,0))
        numArtistsLabel.grid(row = 7, column = 1, padx = 0, sticky = 'w')
        ...
        leftFrame.pack(expand = True, pady = (40,20))
...
class ResultPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        mainLabel = tk.Label(self, text = "Aaaaaaand here you go!", bg = '#226333', font = ('Segoe UI', 32, 'bold'), fg = 'white')
